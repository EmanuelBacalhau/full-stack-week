  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button_previous: 'absolute w-8 h-8 left-1',
        nav_button_next: 'absolute w-8 h-8 right-1',
        table: 'w-full border-collapse space-y-1',
        head_row: 'flex',
        head_cell:
          'text-muted-foreground capitalize rounded-md w-full font-normal text-[0.8rem]',
        ...
        day: cn(
          ...
          'h-9 w-full rounded-none p-0 font-normal aria-selected:opacity-100',
        ),
